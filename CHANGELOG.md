...
- **plancraft**: replace passive mandatory rule with active pre-flight checklist to enforce team-based implementation when Team Roles are defined in the plan
